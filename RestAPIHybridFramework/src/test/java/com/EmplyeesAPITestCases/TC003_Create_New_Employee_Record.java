...
import com.EmplyeesAPIUtilities.RestUtils;

import io.restassured.RestAssured;
import io.restassured.http.Method;

public class TC003_Create_New_Employee_Record extends TestBase
{
	...
	{
		logger.info("************TC003_Create_New_Employee_Record************");
		logger.info("");
		String response_body = response.getBody().asString();
		logger.info("Response Body ===> "+response_body);
		Assert.assertEquals(response_body.contains(empName),true);
		Assert.assertEquals(response_body.contains(empSalary),true);
		Assert.assertEquals(response_body.contains(empAge),true);
		logger.info("-----------------------------------------------------------");
	}
	...
	{
		logger.info("");
		logger.info("************ TC003_Create_New_Employee_Records ************");
	}
